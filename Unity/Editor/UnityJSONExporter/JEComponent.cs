...
//            RegisterConversion(typeof(Light), typeof(JELight));
            ...
            RegisterConversion(typeof(RectTransform), typeof(JETransformRect));
            RegisterConversion(typeof(AnimatedImage), typeof(JEAnimatedImage));
            RegisterConversion(typeof(Image), typeof(JEImage));
            RegisterConversion(typeof(JSONTextHelper), typeof(JEText));
            RegisterConversion(typeof(JSONParticleSystemHelper), typeof(JEParticleSystem));
            RegisterConversion(typeof(Button), typeof(JEButton));
            RegisterConversion(typeof(CanvasScaler), typeof(JECanvasScaler));

            RegisterConversion(typeof(Animator), typeof(JEAnimator));
            RegisterConversion(typeof(JSONScriptEventHelper), typeof(JEScriptEvent));
        }
